...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIAIX7XGJH2IAFHWZXQ',
            secretKey: '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',
            sessionToken: '',
            region: 'us-east-1',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://1a8k3tgp9h.execute-api.us-east-1.amazonaws.com/prod';
